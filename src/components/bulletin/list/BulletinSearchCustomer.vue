...
import { productModalSearchMeta, ProductSearchModalWrapperEmits, ProductSearchModalWrapperProps, ProductSearchRecord } from '@/models'
...
const eventEmits = {
  handleSelect: (searchRecord: ProductSearchRecord) => {
