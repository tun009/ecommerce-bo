...
<template>
  <svg :width="width" :height="height" class="wf-close-icon--color wf-pointer" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      fill-rule="evenodd"
      clip-rule="evenodd"
...
<style scoped>
@import url('@/assets/css/icons/icon-close-rounded.css');
</style>
