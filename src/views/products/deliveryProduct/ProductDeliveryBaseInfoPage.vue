...
import ProductDeliveryMoreInfo from '@/components/products/deliveryProduct/baseInfo/ProductDeliveryMoreInfo.vue'
...
} = useProductBaseInfo(productBaseInfoType.delivery, optionsTypeProduct)
</script>
