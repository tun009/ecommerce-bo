...
import { useProductApprovalDeliveryDetails } from '@/composables/products'
import {
...
} = useProductApprovalDeliveryDetails(productBaseInfoType.delivery)
</script>
...
<template>
  <div class="">
        ...
        <div class="wf_flex wf_flex-1">
          ...
          <div class="wf_flex wf_items-center wf_justify-start wf_h-42 wf-pl-12 wf-pr-11 wf-body_03-reg wf_text--14">
            <WelfareSelect
              ...
              @update:modelValue="(val) => setFieldValue('selectedCategory', val)"
    ...
    <div class="wf_product_border-b-3 wf-pb-10 wf-mb-20">
      <p class="wf-sub_tit_01 wf_text-n-33">상품정보제공고시<span class="wf_text-sub-01"> *</span></p>
    </div>
    ...
    <div class="wf_flex wf_flex-col wf_border-ncc-1">
      <div class="wf_flex wf_flex-row wf_product_border-b-2 wf_w-full wf_flex-grow-1 wf_bg-bg-gray wf_br-tl-6">
        <div v-for="(item, index) in productDeliveryDetailsFormFieldsHeaders" class="wrap-table-header" :key="index">
          <p class="wf_h-42 wf-py-14 wf-px-12 wf-body_02-semi wf_flex wf_justify-center wf_text-n-33">
