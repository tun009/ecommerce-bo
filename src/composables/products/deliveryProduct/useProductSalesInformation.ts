import { ProductSalesTestCase } from '@/models/views'
...
import { ProductTab, ProductSalesTax, ProductSalesCouponPromotionData, ProductSalesDiscountPromotionData } from '@/models/views'
